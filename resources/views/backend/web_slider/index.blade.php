        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="top-right-button-container">
                    <a href="{{route('web_slider.create')}}"><button type="button" class="btn btn-primary btn-sm mb-1 mr-4">Add Slider</button></a>
                    <div class="btn-group">
                ...
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">View All Slider</li>
                    </ol>
                </nav>
                <div class="mb-2">
                ...
                <table id="datatableRows" class="data-table responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if (!empty($data->image))
                                <img src="{{asset($data->image)}}" alt="{{$data->name}}" width="100" height="70">
                                @else
                                No Image Found!
                                @endif
                            </td>
                                ...
                                <div class="form-group row mb-1">
                                    ...
                                    <div class="col-12">
                                        <div class="custom-switch custom-switch-primary mb-2 custom-switch-small" data-toggle="tooltip" data-placement="left" title="" data-original-title="{{$data->is_active==1?'Inactive':'Active'}}">
                                            <input name="status" class="custom-switch-input" id="status{{$data->id}}" data-id="{{$data->id}}" data-url="web_slider/update/" type="checkbox" @if($data->is_active)checked="checked" @endif>
                            ...
                            <td>
                                ...
                                <div class="dropdown d-inline-block">
                                    ...
                                    <div class="dropdown-menu px-3" aria-labelledby="dropdownMenuLink">
                                        @if (Auth::user()->power == 1) <li class="li"> <a href="{{route('web_slider.edit', $data->id)}}" ><i class="fas fa-pencil" aria-hidden="true" style="font-size: 18px;"></i><strong class="ml-2">Edit</strong></a></li>@endif
                                        @if (Auth::user()->power != 3)<li class="li"> <a style="cursor: pointer" class="ml-1" name="delete" id="delete{{$data->id}}" data-url="web_slider/destroy/" data-id="{{ $data->id }}" role="button" ><i class="fa fa-trash" aria-hidden="true" style="font-size: 18px;cursor: pointer;"></i><strong class="ml-2">Delete</strong></a></li>@endif
