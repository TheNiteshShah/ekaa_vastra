        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="top-right-button-container">
                    <a href="{{route('team.create')}}"><button type="button" class="btn btn-primary btn-sm mb-1 mr-4">Add Team</button></a>
                    <div class="btn-group">
                        ...
                        <tr>
                                ...
                                <div class="form-group row mb-1">
                                    ...
                                    <div class="col-12">
                                        <div class="custom-switch custom-switch-primary mb-2 custom-switch-small" data-toggle="tooltip" data-placement="left" title="" data-original-title="{{$data->is_active==1?'Inactive':'Active'}}">
                                            <input name="status" class="custom-switch-input" id="status{{$data->id}}" data-id="{{ $data->id }}" data-url="/status/update" type="checkbox" @if($data->is_active)checked="checked" @endif>
                            ...
                            <td>
                                ...
                                <div class="dropdown d-inline-block">
                                    ...
                                    @if (Auth::user()->power == 1) <li class="li"> <a href="{{route('team.edit', $data->id)}}" ><i class="fas fa-pencil" aria-hidden="true" style="font-size: 18px;"></i><strong class="ml-2">Edit</strong></a></li>@endif
                                        @if (Auth::user()->power != 3)<li class="li"> <a style="cursor: pointer" class="ml-1" name="delete" id="delete{{$data->id}}" data-url="team/destroy/" data-id="{{ $data->id }}" role="button"><i class="fa fa-trash" aria-hidden="true" style="font-size: 18px;cursor: pointer;"></i><strong class="ml-2">Delete</strong></a></li>@endif
