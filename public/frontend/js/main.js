    ...
    t.on("load", function (a, o) {
        ...
        t.on("scroll", function () {
            ...
            s.on("click", ".portfolio-filter li", function () {
                ...
                e(S).isotope({ filter: t }),
                    e(".portfolio-filter li").removeClass("active"),
        ...
        "dark" === R
            ...
            : "light" === R && document.body.classList.toggle("light-theme"),
            J.forEach(function (e) {
                e &&
                    e.addEventListener("click", function () {
                        if (K.matches) {
                            document.body.classList.toggle("light-theme");
                            var e = document.body.classList.contains(
                                "light-theme"
                            )
                                ? "light"
                                : "dark";
                            ...
                            document.body.classList.toggle("dark-theme");
                            e = document.body.classList.contains("dark-theme")
                                ? "dark"
                                : "light";
                        }
...
let pop= document.getElementById("btn-iit")
pop.addEventListener("click",function(){
    let rd= document.getElementById("pop-form")
