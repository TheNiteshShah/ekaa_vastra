                                    ...
                                    <div class="product-action-1 show">
                                        ...
                                        ?>
                                                <span class="iWish<?= $type_data->id ?>">
                                                    <a aria-label="Remove" class="action-btn hover-up" href="javascript:void(0)" product_id="<?= base64_encode($trending->id) ?>" type_id="<?= base64_encode($type_data->id) ?>" status="remove" onclick="wishlistWithFilter(this)"><i class="fi-rs-heart"></i></a>
                                                </span>
                                            <? } else { ?>
                                                <span class="iWish<?= $type_data->id ?>">
                                                <a aria-label="Add" class="action-btn hover-up" href="javascript:void(0)" product_id="<?= base64_encode($trending->id) ?>" type_id="<?= base64_encode($type_data->id) ?>" status="add" onclick="wishlistWithFilter(this)"><i class="fi-rs-heart"></i></a>
                                                </span>
                                            <? }
                                        } else { ?>
