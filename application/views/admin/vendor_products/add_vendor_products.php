                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Vendor Products</h3>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                                <div class="col-lg-10">
                                                        <form action="<?php echo base_url() ?>evadmin/VendorProducts/add_vendor_products_data/<?php echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                                                                <div class="table-responsive">
                                                                        ...
                                                                        <input type="hidden" name="vendor_id" value="<?=$id?>">
                                                                                ...
                                                                                <tr>
                                                                                        ...
                                                                                        <td>
                                                                                                <input type="text" name="unit" class="form-control" placeholder="" required value="" />
                                                                                        </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                        ...
                                                                                        <td>
                                                                                                <input type="text" name="rate" id="rate" onkeypress="return isNumberKey(event)" class="form-control" placeholder="" required value="" />
                                                                                        </td>
                                                                                </tr>
                                                                                <tr>
                                                                                        <td> <strong>GST%</strong> <span style="color:red;">*</span></strong> </td>
                                                                                        <td>
                                                                                                <input type="text" name="gst" id="gst" onkeypress="return isNumberKey(event)" class="form-control" placeholder="" required value="" />
                                                                                        </td>
                                                                                </tr>
                                                                                <tr>
                                                                                        <td> <strong>Rate(With GST)</strong> <span style="color:red;">*</span></strong> </td>
                                                                                        <td><input type="text" name="rgst" id="rgst" readonly class="form-control" placeholder="" required value="" /></td>
                                                                                </tr>
