...
<h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View Reseller</h3>
</div>
<div class="panel panel-default">
...
<div class="panel-body">
  <div class="box-body table-responsive no-padding">
    <table class="table table-bordered table-hover table-striped" id="userTable">
      ...
      <tbody>
        <?php $i=1; foreach ($reseller_data->result() as $data) { ?>
        <tr>
          <td><?php echo $i ?> </td>
          ...
          <td><?php if ($data->reseller_status==0) {?>
          <p class="label bg-yellow">Pending</p>
          <?} elseif ($data->reseller_status==1) {?>
          <p class="label bg-blue">Approved</p>
          <?} else {
          echo("Rejected");
          }
           ?>
