...
<?
          ...
          <ul class="sidebar-menu">
            ...
            <a href="<?=base_url()?>" target="_blank"><li class="header" style="font-size: 14px;"><i class="fa fa-eye"></i>&nbsp;&nbsp; <span>View Site</span></li></a>
...
// exit;
            ...
            $urls= base_url().ADMIN_URL."/".$sd['url'];
                            ...
                            ?>
                            <li class="treeview">
                              <a style="<?php if($currentURL == $urls){ echo 'background-color: #E2D6C0; color: #b14848; border-left-color: black;';}?>" href="<?
                              $this->db->select('*');
