<div class="content-wrapper">
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action="<?php echo base_url() ?>evadmin/Promocode/add_promocode_data/<?php echo base64_encode(2); ?>/<?=$id?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td> <strong>Off Type</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
  ...
  <input type="number" name="giftpercent" class="form-control" placeholder="" required value="" />
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="minorder" class="form-control" placeholder="" required value="<?=$promocode->minorder?>" onkeypress="return isNumberKey(event)" />
                      </td>
                    </tr>
                    <tr id="change2">
                      <?if ($promocode->type==1) {?>
