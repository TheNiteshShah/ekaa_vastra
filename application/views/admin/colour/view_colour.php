...
<h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View Colour</h3>
</div>
<div class="panel panel-default">
...
<div class="box-body table-responsive no-padding">
  <table class="table table-bordered table-hover table-striped" id="userTable">
    ...
    <tbody>
      <?php $i=1; foreach ($colour_data->result() as $data) { ?>
      <tr>
        <td><?php echo $i ?> </td>
<td><?php echo $data->id?></td>
<td><?php echo $data->colour_name?></td>
        <td><span style="background-color:<?php echo $data->name ?>;border-radius:80%">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span> <?php echo $data->name ?> </td>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/colour/rs.js"></script>	  -->
