              ...
              <form action="<?php echo base_url() ?>evadmin/product/add_product_data/<?php echo base64_encode(2); ?>/<?=$id?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td> <strong>Weight(in kg)</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
                        <input type="text" name="weight" class="form-control" placeholder="" required value="<?=$product->weight?>" />
                      </td>
                    </tr>
                    <!-- <tr>
                    ...
                    <tr>
                      ...
                      <td> <input type="text" name="title" class="form-control" placeholder="" required value="<?=$product->title;?>" /> </td>
                    </tr>

                    <tr>
                      <td> <strong>Keyword</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
                        <textarea name="keyword" class="form-control" placeholder="" required id="editor1"><?=$product->keyword;?></textarea>
                         </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <textarea name="dsc" class="form-control" placeholder="" required id="editor1"><?=$product->dsc;?></textarea>
                         </td>
                    </tr>
