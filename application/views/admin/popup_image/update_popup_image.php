      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Update PopUp Image</h3>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <!-- <tr>
                      ...
                      <td>
                        <input type="text" name="name" class="form-control" placeholder="" required value="<?=$popup_image->name?>" />
                      </td>
                    </tr> -->
                    <tr>
                      <td> <strong>Text</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
                        <textarea type="text" id="editor1" name="text" class="form-control" placeholder="" required>
                          <?=$popup_image->text?>
                        </textarea>
                      </td>
                    </tr>
                    <tr>
                      <td> <strong>Image</strong> <span style="color:red;"><br />Size: 340px X 400px</span></strong> </td>
                      <td>
                        <input type="file" name="image" class="form-control" placeholder=""/>
                        <?if(!empty($popup_image->image)){?>
                        <img id="slide_img_path" height=50 width=100 src="<?php echo base_url().$popup_image->image?>">
                        <?}else{?>
