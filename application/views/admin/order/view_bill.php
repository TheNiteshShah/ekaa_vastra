...
<head>
  ...
  <title>Ekaa Vastra Invoice</title>
</head>
<body style="padding-top:75px;">
  <div class="container main_container">  
    <div class="row">
      <div class="col-sm-6 oswal_logo">
        <img src="<?= base_url() ?>assets/frontend/images/logo.png" class="img-fluid" style="width:150px;">
      </div>
      ...
      <div class="row">
        <div class="col-sm-6"><span class="font-weight-bold ">Sold By</span><br>
          <span class="seller_details">Ekaa Vastra <br>
           Sunshine Aditya, Maharana Pratap Marg, <br> Near Teoler High School, Jaipur, Rajasthan 
            <br> 302012
            <br>
            www.ekaavastra.com
            <br>
