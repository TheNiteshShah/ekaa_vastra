...
<?}?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View Attributes</h3>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="box-body table-responsive no-padding">
                <table class="table table-bordered table-hover table-striped" id="userTable">
                  ...
                  <tbody>
                    <?php $i=1; foreach ($attribute_data->result() as $data) { ?>
                    <tr>
                      <td><?php echo $i ?> </td>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/attribute/rs.js"></script>	  -->
