...
<h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View Percentage Off</h3>
</div>
<div class="panel panel-default">
...
<div class="box-body table-responsive no-padding">
  ...
  <?}?>
    ...
    <tbody>
      <?php $i=1; foreach ($percentage_data->result() as $data) { ?>
      <tr>
        <td><?php echo $i ?> </td>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/percentage/rs.js"></script>	  -->
