...
<h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Percentage Off</h3>
</div>
...
<div class="col-lg-10">
<form action="<?php echo base_url() ?>evadmin/Percentage_off/add_percentage_off_data/<?php echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
