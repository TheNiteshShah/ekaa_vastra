...
<h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Update Percentage Off</h3>
</div>
...
<div class="table-responsive">
  <table class="table table-hover">
    ...
    <tr>
      ...
      <td>
        <input type="text" name="percentage" class="form-control" placeholder="" required value="<?=$percentage->percentage?>" onkeypress="return isNumberKey(event)" />
      </td>
    </tr>
    <tr>
      <td colspan="2">
