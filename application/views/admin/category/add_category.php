      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action="<?php echo base_url() ?>evadmin/Category/add_category_data/<?php echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="seq" onkeypress="return isNumberKey(event)" class="form-control" placeholder="" required value="" />
                      </td>
                    </tr>
                    <tr>
