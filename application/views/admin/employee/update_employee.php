...
<li><a href="<?php echo base_url() ?>evadmin/employee/view_emplouee"><i class="fa fa-undo" aria-hidden="true"></i> View employee </a></li>
...
<div class="col-lg-10">
<form action="<?php echo base_url() ?>evadmin/employee/add_employee_data/<?php echo base64_encode(2); ?>/<?=$id?>" method="POST" id="slide_frm" enctype="multipart/form-data">
