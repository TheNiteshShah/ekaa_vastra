...
class Type extends CI_finecontrol
{
            ...
            if ($this->input->post()) {
                ...
                if ($this->form_validation->run() == true) {
                    ...
                    if ($file_check != 4) {
                        ...
                        $new_file_name = "type" . date("YmdHis");
                    ...
                    if ($file_check != 4) {
                        ...
                        $new_file_name = "type2" . date("YmdHis");
                        $this->upload_config = array(
                            'upload_path'   => $image_upload_folder,
                            'file_name' => $new_file_name,
                            'allowed_types' => 'jpg|jpeg|png',
                    ...
                    if ($file_check != 4) {
                        ...
                        $new_file_name = "type3" . date("YmdHis");
                        $this->upload_config = array(
                            'upload_path'   => $image_upload_folder,
                            'file_name' => $new_file_name,
                            'allowed_types' => 'jpg|jpeg|png',
                    ...
                    if ($file_check != 4) {
                        ...
                        $new_file_name = "type4" . date("YmdHis");
                        $this->upload_config = array(
                            'upload_path'   => $image_upload_folder,
                            'file_name' => $new_file_name,
                            'allowed_types' => 'jpg|jpeg|png',
                    ...
                    if ($file_check != 4) {
                        ...
                        $new_file_name = "type5" . date("YmdHis");
                        $this->upload_config = array(
                            'upload_path'   => $image_upload_folder,
                            'file_name' => $new_file_name,
                            'allowed_types' => 'jpg|jpeg|png',
    ...
    public function copy_type($idd)
    {
        if (!empty($this->session->userdata('admin_data'))) {
            ...
            $data['product_data'] = $this->db->get();
            $this->load->view('admin/common/header_view', $data);
            $this->load->view('admin/type/copy_type');
            $this->load->view('admin/common/footer_view');
        } else {
            redirect("login/admin_login", "refresh");
        }
    ...
    public function import_type_data()
    {
        ...
        if ($file_check != 4) {
            ...
            $new_file_name = "type_excel" . date("YmdHis");
            $this->upload_config = array(
                'upload_path'   => $image_upload_folder,
                'file_name' => $new_file_name,
